...
public class Ex1Fibonacci {
	...
	public static void main(String[] args) {
			//Declare the array list with 25 positions initial
			...
			// Do a loop introducing the fibonacci sequence
			for(int i = 2; i< 25; i++){
			...
			System.out.println("La seva posició és " + seqfibonacci.indexOf(2584));
				...
				if (seqfibonacci.indexOf(4311) == -1){
					...
					System.out.println("El valor 4311 SI apareix a la sequencia fibonacci en la posició " + seqfibonacci.indexOf(2584));
				}
